          ...
          {totalUnRead > 0 && (
            <Tooltip title=" Mark all as read">
              <IconButton color="primary" onClick={handleMarkAllAsRead}>
                <Iconify icon="solar:check-read-bold-duotone" width={20} />
              </IconButton>
            </Tooltip>
          )}
        </Box>
...
function renderContent(notification: NotificationItemProps) {
  ...
  if (notification.type === 'order-placed') {
    return {
      avatarUrl: <Iconify icon="solar:box-bold-duotone" width={24} />,
      title,
    };
  }
  if (notification.type === 'order-shipped') {
    return {
      avatarUrl: <Iconify icon="solar:delivery-bold-duotone" width={24} />,
      title,
    };
  }
  if (notification.type === 'mail') {
    return {
      avatarUrl: <Iconify icon="solar:letter-bold-duotone" width={24} />,
      title,
    };
  }
  if (notification.type === 'chat-message') {
    return {
      avatarUrl: <Iconify icon="solar:chat-round-dots-bold-duotone" width={24} />,
      title,
    };
  }
  return {
